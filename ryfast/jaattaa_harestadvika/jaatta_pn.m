...
global_info.generated_mass_jaattaa = 0; %generated mass in m3
global_info.truck_capacity = 5; %capacity in m3
global_info.mass_per_blast = 110;
global_info.road_jaattaa_harestadvika_capacity = 7; %capacity of trucks on road each way
global_info.dumped_at_harestadvika = 0;

pns = pnstruct('jaattaa_pn_pdf'); % create petri net structure

dyn.m0 = {'pStorageAtJaattaa',0,...
          'pTransportVehicles',global_info.road_jaattaa_harestadvika_capacity,...
          'pEnroute',0,...
          'pDumpAtHarestadvika',0,...
...
fprintf('amount dumped today: %s\n', num2str(global_info.dumped_at_harestadvika));
