...
global_info.road_kuneset_rosenberg_capacity = 2; %capacity of barge on road each way
global_info.dumped_at_rosenberg = 0;

pns = pnstruct('rosenberg_pn_pdf'); % create petri net structure

dyn.m0 = {'pStorageAtKuneset',280/global_info.barge_capacity,...
          'pTransportVehicles',global_info.road_kuneset_rosenberg_capacity,...
          'pEnroute',0,...
          'pDumpAtRosenberg',0,...
