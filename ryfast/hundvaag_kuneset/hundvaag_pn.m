...
global_info.mass_per_blast = 280;
global_info.road_hundvaag_kuneset_capacity = 2; %capacity of trucks on road each way
global_info.dumped_at_kuneset = 0;

pns = pnstruct('hundvaag_pn_pdf'); % create petri net structure

dyn.m0 = {'pStorageAtHundvaag',global_info.mass_per_blast/global_info.truck_capacity,...
